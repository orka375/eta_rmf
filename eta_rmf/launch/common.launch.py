...
def generate_launch_description():
    ...
    map_arg = DeclareLaunchArgument('map_path', default_value=os.path.join(get_package_share_directory('eta_rmf_maps'), 'maps', 'eta_office', 'eta_office.building.yaml'))
    ...
    viz_config_file_arg = DeclareLaunchArgument('viz_config_file', default_value=os.path.join(get_package_share_directory('eta_rmf'), 'rviz_config', 'office.rviz'))
