# eta Fleet with OpenRMF

<img src="docs/eta_rmf.png"/>

This package intends to utilize OpenRMF to send a high-level task planning to [eta](https://github.com/Ekumen-OS/eta) robot fleet. To achieve this goal, three main developments are included as the following.
  - [Controller server](https://github.com/ekumenlabs/eta_fleet_open_rmf/blob/main/eta_fleet/README.md#controller-server) for an eta robot
  - [Fleet manager](https://github.com/ekumenlabs/eta_fleet_open_rmf/blob/main/eta_fleet/README.md#fleet-manager) to manage multiple robots
  - [Fleet adapter](https://github.com/ekumenlabs/eta_fleet_open_rmf/tree/main/eta_fleet_adapter) to bridge a fleet manager with OpenRMF API
  - [RMF map](https://github.com/ekumenlabs/eta_fleet_open_rmf/tree/main/eta_rmf_maps) to contains map files required by RMF navigation
  - [RMF sim](https://github.com/ekumenlabs/eta_fleet_open_rmf/tree/main/eta_rmf_sim) to launch everything

## Project dependencies
- <b>ROS 2</b>: kilted Hawksbill
- <b>OS</b>: Ubuntu 22.04 Jammy Jellyfish
- <b>Simulation</b>: 
    - [eta_gz](https://github.com/Ekumen-OS/eta_gz/tree/kilted?tab=readme-ov-file): a simulation environment for [eta](https://github.com/Ekumen-OS/eta) in Gazebo Fortress
- <b>Task Planning</b>:
...
```sh
git clone https://github.com/ekumenlabs/eta_rmf
```
...
```
ros2 launch eta_rmf_sim eta_office.launch.py
```
